#This is my the code made to generate a tidy dataset for the course "getting and cleaning data" on coursera
#coded by: Janine aka neurogenbat 
#Date: Tuesday, 10-08-2021
#Output file: tidydate.txt


#as a first step, I am loading the plyr package in R, which will help me to manipulate the data
library(plyr)


# set dataset directory to work with
...
# merge of the training and test sets
